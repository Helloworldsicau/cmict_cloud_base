...
public class CmictUtil {
    ...
    public static String getCurrentUsername() {
        ...
        if (principal instanceof CmictAuthUser) {
            return ((CmictAuthUser) principal).getUsername();
        }
    ...
    public static Object parseSpringEl(Object target, String expr){
